...
class DPOTrainer(Trainer):
    ...
    def __init__(
        ...
        loss_type: Literal["sigmoid", "hinge", "ipo", "kto_pair", "distill" , "simpo"] = "sigmoid",
    ...
    def dpo_loss(
        ...
        if self.loss_type == "sigmoid":
            ...
            if self.state.global_step < (self.state.max_steps * 0.2) :
                ...
                alpha = self.alpha
            losses = (
                -F.logsigmoid(self.beta * logits) * (1 - alpha + alpha *  pref_score_chosen)
                - F.logsigmoid(-self.beta * logits) * (alpha -  alpha * pref_score_chosen)
            )
